...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b>ʜᴇʏ {user} 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ <a href=https://t.me/+goi1zMdCehA3Mzc9>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇</b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/+goi1zMdCehA3Mzc9")]])
    )
    ...
    try:
        if settings['max_btn']:
            ...
            if n_offset == 0:
                ...
                btn.append(
                    [
                        InlineKeyboardButton("🏃‍♂️𝖻𝖺𝖼𝗄", callback_data=f"next_{req}_{key}_{off_set}"),
...
async def filter_languages_cb_handler(client: Client, query: CallbackQuery):
    ...
    if offset != "":
        ...
        btn.append(
            [InlineKeyboardButton(text="🧩𝖭𝗈 𝗆𝗈𝗋𝖾 𝗉𝖺𝗀𝖾 𝖺𝗏𝖺𝗂𝗅𝖺𝖻𝗅𝖾🧩",callback_data="pages")]
        )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://t.me/+goi1zMdCehA3Mzc9")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        try:
            ...
            xo = await query.message.reply_sticker("CAACAgUAAxkBAAIUlWXwLpJpNu0orMMZqLw6Fs9W6zSYAAJeCgACdYTYVycsDgtn8w9_NAQ")
    ...
    # don't change anything without contacting me @creatorrio
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('🏞️ 𝖬𝗈𝗏𝗂𝖾 𝗀𝗋𝗈𝗎𝗉 🏞️', url=GRP_LNK)
                ],[
        ...
        buttons = [[
             ...
             InlineKeyboardButton('❄️𝖳𝖾𝗅𝖾𝗀𝗋𝖺𝗉𝗁❄️', callback_data='tele') 
         ], [ 
             InlineKeyboardButton('🪂𝖢𝗈𝗇𝗇𝖾𝖼𝗍𝗂𝗈𝗇𝗌🪂', callback_data='coct'), 
             InlineKeyboardButton('🏞️𝖥𝗂𝗅𝗍𝖾𝗋𝗌🏞️', callback_data='filters'),  
             InlineKeyboardButton('☔𝖸𝖳-𝖽𝗅☔', callback_data='ytdl') 
         ], [ 
             InlineKeyboardButton('☃️𝖲𝗁𝖺𝗋𝖾 𝗍𝖾𝗑𝗍☃️', callback_data='share'), 
        ...
        await query.message.edit_text(
            ...
            btn = [[
                InlineKeyboardButton("👇𝖲𝖾𝗅𝖾𝖼𝗍 𝖸𝗈𝗎𝗋 𝗅𝖺𝗇𝗀𝗎𝖺𝗀𝖾𝗌👇", callback_data="laninfo")
        ], [
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
                    InlineKeyboardButton("𝚃𝚑𝚎 𝙱𝚘𝚜𝚜🫀", url="telegram.me/venom_darshu")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
                    InlineKeyboardButton("𝚃𝚑𝚎 𝚋𝚘𝚜𝚜🫀", url="telegram.me/venom_darshu")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.append(
            [InlineKeyboardButton(text="🧩𝖭𝗈 𝗆𝗈𝗋𝖾 𝗉𝖺𝗀𝖾𝗌 𝖺𝗏𝖺𝗂𝗅𝖺𝖻𝗅𝖾🧩",callback_data="pages")]
        )

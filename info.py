...
URL = "https://mickey.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://mickey.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://mickey.onrender.com/".format(FQDN)
else:
    URL = "https://mickey.onrender.com/".format(FQDN)

...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002190166229').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002180849680') # give your force subscribe channel id here else leave it blank

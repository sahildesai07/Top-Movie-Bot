...
API_ID = int(environ.get('API_ID', '22296665')
API_HASH = environ.get('API_HASH', '16d3e2f482f62f560d9f19b07d8606c0')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6891215494').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-100202456909').split()]
...
# MongoDB information
DATABASE_URI = environ.get("mongodb+srv://Mickey:Dwip555@dwip.ck0hnxc.mongodb.net/?retryWrites=true&w=majority&appName=Dwip")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL','-1002130365677')
